...
export const COMMAND_IDS = {
  ...
  OPEN_FLOATING_AGENT_CHAT: "open-floating-agent-chat",
...
export const COMMAND_NAMES: Record<CommandId, string> = {
  ...
  [COMMAND_IDS.OPEN_FLOATING_AGENT_CHAT]: "Open floating Copilot chat",
...
export const COMMAND_ICONS: Partial<Record<CommandId, string>> = {
  ...
  [COMMAND_IDS.OPEN_FLOATING_AGENT_CHAT]: COPILOT_AGENT_ICON_ID,
