 ...
 * `opencode/` wire-id prefix and make up opencode's free model tier. Pickers
 * surface a privacy warning for these because, unlike a self-hosted/BYOK
 * model, prompts are sent to a third party whose terms may allow logging or
 * training.
 */
